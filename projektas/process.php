...
class Process {
    ...
    function Process() {
        ...
        /* User submitted registration form */ else if (isset($_POST['subjoin'])) {
		 ...
		 /* User submitted registration form */ else if (isset($_POST['subjoin2'])) {
            $this->procRegister2();
        }
    ...
    function procRegister() {
        ...
        $retval = $session->register($_POST['user'],$_POST['username'],$_POST['pavarde'],$_POST['adresas'],$_POST['usernr'], $_POST['pass'], $_POST['email'],$_POST['imone']);
 ...
 function procRegister2() {
        ...
        /* Registration attempt */
        $retval = $session->register2($_POST['username'],$_POST['user'],$_POST['user2'],$_POST['pass'],$_POST['pareigos'], $_POST['imone'],$_POST['email']);

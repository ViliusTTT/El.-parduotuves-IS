                ...
                <td>
                                    ...
                                    <tr>
                                        <td>
                                            <form action="process.php" method="POST" class="login">
                                                <center style="font-size:18pt;"><b>Darbuotojo registracija</b></label>
                                                </center>
                                                ...
                                                <p style="text-align:left;">Pavardė:
                                                    <input class="s1" name="user2" type="text" size="15" value="<?php echo $form->value(" user2 "); ?>"/><br>
                                                    <?php echo $form->error("user2"); ?>
                                                </p>
                                                ...
                                                <p style="text-align:left;">Pareigos:
                                                    <select id="brand1" name="pareigos">
					<option value="-1">Pasirinkite pareigų tipą</option>
					<?php
						// išrenkame visas markes
						$brands = $session->getPareiguTipai();
						foreach($brands as $key => $val) {
							$selected = "";
							if(isset($fields['pareigos']) && $fields['pareigos'] == $val['id_PareigosTipai']) {
								$selected = " selected='selected'";
							}
							echo "<option{$selected} value='{$val['id_PareigosTipai']}'>{$val['name']}</option>";
							echo $form->value($val['id_PareigosTipai']);
						}
					...
					?>
                                                    ...
                                                    <p style="text-align:left;">
                                                        <input type="hidden" name="subjoin2" value="1">
